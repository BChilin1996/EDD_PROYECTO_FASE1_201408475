...
public class PilaImagenes {
    ...
    // tope de la pila.
    private NodoPilaImagenes inicio;
    // Variable para registrar el tamaño de la pila.
    private int tamanio;
    /**
     * Constructor por defecto.
     */
    public void PilaImagenes(){
        inicio = null;
        tamanio = 0;
    }
    /**
    ...
    public void apilar(int valor){
    	...
    	NodoPilaImagenes nuevo = new NodoPilaImagenes();
    ...
    public void remover(int referencia){
        ...
        if (buscar(referencia)) {
            ...
            while(referencia != inicio.getValor()){
            	...
            	NodoPilaImagenes temp = new NodoPilaImagenes();
    ...
    public String listar(int id_cliente, String nodo_ventanilla){
        // Crea una copia de la pila.
    	NodoPilaImagenes aux = inicio;
    	String str_="";
        // Recorre la pila hasta el ultimo nodo.
        while(aux != null){
			str_ = str_ +"\"node_"+id_cliente+"_"+ aux.getValor()+"\""+ "[" +"label = \""+aux.getValor() + "\"\r\n"
					+ "shape = \"record\"\r\n"
					+ "];"+"\n";
            aux = aux.getSiguiente();
        }        
    ...
    public String lista_epera(int id_cliente){
        // Crea una copia de la pila.
    	NodoPilaImagenes aux = inicio;
        NodoPilaImagenes aux_ = inicio;
    	String str_="";
        // Recorre la pila hasta el ultimo nodo.
  
        while(aux != null){
			str_ = str_ +"\"node_"+id_cliente+"_"+ aux.getValor()+"\""+ "[" +"label = \" Cliente "+id_cliente+" Imagen "+aux.getValor() + "\"\r\n"
					+ "shape = \"record\"\r\n"
					+ "];"+"\n";
            aux = aux.getSiguiente();
        }        
        
        str_ = str_ +"\"node"+id_cliente+"\" -> \"node_"+id_cliente+"_"+ aux_.getValor()+"\"\n";
        while (aux_.getSiguiente() != null) {
        	  str_ = str_ +"\"node_"+id_cliente+"_"+ aux_.getValor()+"\" -> \"node_"+id_cliente+"_"+ aux_.getSiguiente().getValor()+"\"\n";
        	  aux_ = aux_.getSiguiente();
        }
    ...
    public String listar_nodos(int id_cliente, String nodo_ventanilla){
        // Crea una copia de la pila.
    	if (inicio!=null) {
    	...
    	NodoPilaImagenes aux = inicio;
    	String str_="";
    	str_ = str_ +"\""+ nodo_ventanilla +"\"-> "+"\"node_"+id_cliente+"_"+ aux.getValor()+"\"\n";
    	 while(aux.getSiguiente() != null){
 			str_ =  str_ +"\"node_"+id_cliente+"_"+ aux.getValor()+"\""+"-> "+"\"node_"+id_cliente+"_"+ aux.getSiguiente().getValor()+"\""+"\n";
            aux = aux.getSiguiente();
         }  
        return str_;
    	}else {
